...
lm_cv_model_simple <- lm_cv_model
save(lm_cv_model_simple, file="01-LRS_cv_260824.RData")
...
writeRaster(pred_raster, filename = "D:/Josefina/Proyectos/ProyectoChile/modelos/SalidaModelo/01-LRSimple_cv_260824.tif", format = "GTiff", overwrite = TRUE)
