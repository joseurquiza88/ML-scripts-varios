...
dir_salida <- paste("D:/Josefina/Proyectos/ProyectoChile/",estacion,"/modelos/salidas/SalidasDiarias/02-RF_cv_M1-261224_MX/",sep="")
# Fechas de inter?s
fechaInicio <- as.Date("28-12-2023", format = "%d-%m-%Y")
fechaFin <- as.Date("31-12-2023", format = "%d-%m-%Y")
###
fechaNDVI<- as.Date("01-12-2023", format = "%d-%m-%Y")
...
#V10_raster <- raster(paste("05_ERA5/",fechaInteres,"-V10_raster_",numRaster,".tif",sep=""))
  ...
  name_salida <- paste(dir_salida,"PM-",fechaInteres,"02-RF_cv_M1-261224_MX.tif",sep="")
