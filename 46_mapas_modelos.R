...
nombre_salida <- "07-RF-ESP_cv_M6-110225-MD"
...
# Fechas de inter?s
fechaInicio <- as.Date("07-06-2024", format = "%d-%m-%Y")
fechaFin <- as.Date("30-06-2024", format = "%d-%m-%Y")
###
fechaNDVI<- as.Date("01-06-2024", format = "%d-%m-%Y")
...
#  V10_raster <- raster(paste("05_ERA5/",fechaInteres,"-V10_raster.tif",sep=""))
  ...
  name_salida <- paste(dir_salida,"PM-",fechaInteres,nombre_salida,".tif",sep="")
